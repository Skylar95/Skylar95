...
- 偏态
	...
	![偏态](https://github.com/reasonW/MyImage/blob/master/reasonW.github.io/_posts/2017-03-06-img/Negative_and_positive_skew_diagrams.png?raw=true)
...
<center>$	I1=\eta_{20}+\eta_{02} $ <br>$
	I2=(\eta_{20}−\eta_{02})^2+4\eta_{11}^2 $<br>$
	I3=(\eta_{30}−3\eta_{12})^2+(3\eta_{21}−\eta_{03})^2 $<br>$
	I4=(\eta_{30}+\eta_{12})^2+(\eta_{21}+\eta_{03})^2  $<br>$
	I5=(\eta_{30}−3\eta_{12})(\eta_{30}+\eta_{12})[(\eta_{30}+\eta_{12})^2−3(\eta_{21}+\eta_{03})^2]+(3\eta_{21}−\eta_{03})(\eta_{21}+\eta_{03})[3(\eta_{30}+\eta_{12})^2−(\eta_{21}+\eta_{03})^2]  $<br>$
	I6=(\eta_{20}−\eta_{02})[(\eta_{30}+\eta_{12})^2−(\eta_{21}+\eta_{03})^2]+4\eta_{11}(\eta_{30}+\eta_{12})(\eta_{21}+\eta_{03})  $<br>$
...
<br>第一个，I1,类似于围绕图像的质心的惯性矩，像素强度类似于物理密度。
...
PCL 关于矩的使用有两个，一个是 `pcl::MomentOfInertiaEstimation `类，实现基于惯性矩提取特征，还计算投影云的AABB,OBB 和偏心率。一个是`pcl::MomentInvariantsEstimation`,估计每个3D点处的三个矩不变量`(j1,j2,j3)`
